...
const resendKey = process.env.RESEND_API_KEY || 're_9FU9EPTH_JNAbw7xJ3gRb9spgmE6Lm1dt';
console.log('[BRISC API] Resend API key present:', !!process.env.RESEND_API_KEY);
      ...
      try {
        ...
        if (leadError) {
          ...
          if (leadError.code === '23505') {
            ...
            console.error('[BRISC API] Lead error details:', JSON.stringify(leadError, null, 2));
